...
void AbstractGame::_initializeWindow()
{
	...
	_window = new sf::RenderWindow(sf::VideoMode(1920, 1080), "Murder in the Shadows", sf::Style::Default, sf::ContextSettings(24, 8, 0, 3, 3));
...
void AbstractGame::run()
{
	...
	//settings to make sure the update loop runs at 144 fps baby
	sf::Time timePerFrame = sf::seconds(1.0f / 144.0f);
